...
const encode = (obj, opt = {}) => {
  ...
  const commentsDictionary = hasOwnProperty.call(obj, 'comments') ? obj.comments : {}
  ...
  for (const k of children) {
    ...
    const childObject = hasOwnProperty.call(obj, 'comments') ?
      Object.assign(obj[k], { comments: obj.comments }) :
      obj[k]
